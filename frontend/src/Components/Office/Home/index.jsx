...
function Home() {
  return (
    <div className="p-8 w-screen overflow-x-hidden">
      ...
      <div className="">
        ...
        <div className="card shadow mb-0 my-2">
          <a
            href="/office/batches/add-batch"
            className="card-body text-black cursor-pointer"
          >
            <div className="">
              <div className="me-2 flex justify-between items-center">
                <p className="text-sm uppercase text-gray-600 mb-0">
                  Host new Batch
                </p>
        ...
        <div className="card shadow mb-0 my-2">
          <a
            href="/office/teachers/add-teacher"
            className="card-body text-black cursor-pointer"
          >
            <div className="">
              <div className="me-2 flex justify-between items-center">
